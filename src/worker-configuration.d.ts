/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 18bfe88df98393cc1da78598fa8cdef1)
// Runtime types generated with workerd@1.20250508.0 2025-05-21 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PUBLIC_COOKIE_DOMAIN: ".byulmaru.co";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_COOKIE_DOMAIN" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "DATABASE_URL" | "OIDC_JWK" | "PUBLIC_OIDC_ISSUER">> {}
}
